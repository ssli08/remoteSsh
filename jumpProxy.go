...
func init() {
	...
	flag.StringVar(&remotePass, "remotePass", "ec2@123", "password of remote host for ssh connetion")

	flag.StringVar(&jumperHost, "jumperHost", "8.8.8.8", "jumper host for ssh connection")
